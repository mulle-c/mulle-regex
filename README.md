...
mulle-regex is a component of the [mulle-core](//github.com/mulle-core/mulle-core) library. So in your code include the mulle-core umbrella header:
...
### Embed mulle-regex with clib

``` sh
clib install --out src mulle-c/mulle-regex
```
